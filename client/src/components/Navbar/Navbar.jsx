...
const NavBarItem = ({ title, classprops }) => (
  ...
  return (
    <nav className="w-full flex md:justify- justify-between items-center p+10">
      <div className="md:flex-[0.15] flex-initial justify-center items-center">
        {/* <h1 className="text-[40px] font-serif text-white cursor-pointer">{`ThinkRoman Ventures`}</h1> */}
        <img src="logop.png"></img>
      </div>
      <ul className="text-black md:flex hidden list-none flex-[0.9] justify-between items-right flex-initial">
        {[""].map((item, index) => (
        ...
        {user?.result ? (
          <div className={classes.profile}>
            ...
            <Typography className={`flex items-center text-black`} variant="h6">{user?.result.name}</Typography>
      ...
      <div className="md:flex-[0.2] flex-initial justify-right items-right">
        {user &&(
